...
def Receipt():
    ...
    txtReceipt.insert(END, 'Brownies:\t\t\t'+E_Brownies.get()+"\n")
    txtReceipt.insert(END, 'Bread:\t\t\t'+E_Bread.get()+"\n")
    txtReceipt.insert(END, 'Milk Cake:\t\t\t'+ E_M_Cake.get()+"\n")
    txtReceipt.insert(END, 'Barfi:\t\t\t'+ E_Barfi.get()+"\n")
    txtReceipt.insert(END, 'Nankhatai:\t\t\t'+ E_Nankhatai.get()+"\n")
    txtReceipt.insert(END, 'Cold Drinks:\t\t\t'+E_C_Drinks.get()+"\n")
    txtReceipt.insert(END, 'Chips:\t\t\t'+E_Chips.get()+"\n")
    txtReceipt.insert(END, 'Nimco:\t\t\t'+E_Nimco.get()+"\n")
    txtReceipt.insert(END, 'Rusk:\t\t\t'+E_Rusk.get()+"\n")
